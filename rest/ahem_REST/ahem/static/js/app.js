(function(){
	...
	return {
		restrict: 'E',
		templateUrl: 'static/templates/stafflist.html',
	};
    });
   ...
   app.directive('ahemlog', function(){
	return {
		restrict: 'E',
		templateUrl: 'static/templates/ahem-log.html',
	};
    });
   ...
   app.controller('EmployeeListController', function($scope, $http, $filter, $q){
	...
	this.selectSelf = function(){
        ...
        $scope.religions= [
            {value: 'BU', text: 'Buddhist'},
            {value: 'CR', text: 'Christian'},
            {value: 'UD', text: 'Undeclared'},
            {value: 'IS', text: 'Muslim'},
            {value: 'NF', text: 'No Faith'},
        ];
